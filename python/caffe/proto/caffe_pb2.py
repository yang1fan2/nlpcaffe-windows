...
_LAYERPARAMETER = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='lstm_param', full_name='caffe.LayerParameter.lstm_param', index=29,
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='prelu_param', full_name='caffe.LayerParameter.prelu_param', index=34,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='python_param', full_name='caffe.LayerParameter.python_param', index=35,
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='wordvec_param', full_name='caffe.LayerParameter.wordvec_param', index=43,
...
_CONCATPARAMETER = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='fast_lstm_concat', full_name='caffe.ConcatParameter.fast_lstm_concat', index=2,
...
_LSTMPARAMETER = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='num_cells', full_name='caffe.LstmParameter.num_cells', index=0,
      number=1, type=13, cpp_type=3, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='input_weight_filler', full_name='caffe.LstmParameter.input_weight_filler', index=1,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='input_gate_weight_filler', full_name='caffe.LstmParameter.input_gate_weight_filler', index=2,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='forget_gate_weight_filler', full_name='caffe.LstmParameter.forget_gate_weight_filler', index=3,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='output_gate_weight_filler', full_name='caffe.LstmParameter.output_gate_weight_filler', index=4,
...
_SOFTMAXPRODUCTPARAMETER = _descriptor.Descriptor(
  name='SoftmaxProductParameter',
  full_name='caffe.SoftmaxProductParameter',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='num_output', full_name='caffe.SoftmaxProductParameter.num_output', index=0,
      number=1, type=13, cpp_type=3, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='num_categories', full_name='caffe.SoftmaxProductParameter.num_categories', index=1,
      number=2, type=13, cpp_type=3, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='weight_filler', full_name='caffe.SoftmaxProductParameter.weight_filler', index=2,
      number=3, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_WORDVECPARAMETER = _descriptor.Descriptor(
  name='WordvecParameter',
  full_name='caffe.WordvecParameter',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='dimension', full_name='caffe.WordvecParameter.dimension', index=0,
      number=1, type=13, cpp_type=3, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='vocab_size', full_name='caffe.WordvecParameter.vocab_size', index=1,
      number=2, type=13, cpp_type=3, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='weight_filler', full_name='caffe.WordvecParameter.weight_filler', index=2,
      number=3, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_SLICEPARAMETER = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='fast_wordvec_slice', full_name='caffe.SliceParameter.fast_wordvec_slice', index=1,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='slice_point', full_name='caffe.SliceParameter.slice_point', index=2,
      number=2, type=13, cpp_type=3, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='slice_dim', full_name='caffe.SliceParameter.slice_dim', index=3,
      number=1, type=13, cpp_type=3, label=1,
      has_default_value=True, default_value=1,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_LAYERPARAMETER.fields_by_name['wordvec_param'].message_type = _WORDVECPARAMETER
...
_LSTMPARAMETER.fields_by_name['input_weight_filler'].message_type = _FILLERPARAMETER
_LSTMPARAMETER.fields_by_name['input_gate_weight_filler'].message_type = _FILLERPARAMETER
_LSTMPARAMETER.fields_by_name['forget_gate_weight_filler'].message_type = _FILLERPARAMETER
_LSTMPARAMETER.fields_by_name['output_gate_weight_filler'].message_type = _FILLERPARAMETER
_SOFTMAXPRODUCTPARAMETER.fields_by_name['weight_filler'].message_type = _FILLERPARAMETER
_WORDVECPARAMETER.fields_by_name['weight_filler'].message_type = _FILLERPARAMETER
...
DESCRIPTOR.message_types_by_name['SoftmaxProductParameter'] = _SOFTMAXPRODUCTPARAMETER
DESCRIPTOR.message_types_by_name['WordvecParameter'] = _WORDVECPARAMETER
...
SoftmaxProductParameter = _reflection.GeneratedProtocolMessageType('SoftmaxProductParameter', (_message.Message,), dict(
  DESCRIPTOR = _SOFTMAXPRODUCTPARAMETER,
  __module__ = 'caffe_pb2'
  # @@protoc_insertion_point(class_scope:caffe.SoftmaxProductParameter)
  ))
_sym_db.RegisterMessage(SoftmaxProductParameter)

WordvecParameter = _reflection.GeneratedProtocolMessageType('WordvecParameter', (_message.Message,), dict(
  DESCRIPTOR = _WORDVECPARAMETER,
  __module__ = 'caffe_pb2'
  # @@protoc_insertion_point(class_scope:caffe.WordvecParameter)
  ))
_sym_db.RegisterMessage(WordvecParameter)
